            ...
            <section className="about">
                <Container>
                    <div className="row mt-5">
                        ...
                        <div className="col-md-6 mt-5">
                            <div className="mb-4">
                                <h3 className="about-subHeading">My Skill Set</h3>
                            ...
                            <div className="mb-4">
                                <h3 className="about-subHeading">Eager to work with</h3>
                                <h6>Others: {skills.workingSkills.map(skill => <span className="mr-1 my-1 badge badge-info">{skill}</span>)}</h6>
                            </div>
                            <div className="mb-4">
                                <h3 className="about-subHeading">Prefer not to work with</h3>
