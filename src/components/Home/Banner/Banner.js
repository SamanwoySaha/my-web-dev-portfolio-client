                    ...
                    <div className="col-sm-12 col-md-8">
                        <div className="banner-content" style={{ marginLeft: '100px'}}>
                            <div className="d-flex align-items-center mb-4">
                                <img className="img-fluid w-25 mr-4" src="https://i.imgur.com/xjpx9j2.png" alt="" />
                                <div className="text-left">
                                    <Typical
                                        steps={['<>Hello World!</>', 2000, "I'm", 2000]}
                                        loop={Infinity}
                                        wrapper="h2"
                                    />
                                    <h1><span className="special">Samanwoy</span> Saha</h1>
                                    <h3 className="mb-3">Web Developer | Programmer</h3>
                                    <div>
                                        <a href="http://github.com/SamanwoySaha"><FaGithubSquare className="header-icon icon mr-3" /></a>
                                        <a href="https://medium.com/@samanwoy-saha"><FaMedium className="header-icon icon mx-3" /></a>
                                        <a href="https://www.linkedin.com/in/samanwoy-saha/"><FaLinkedin className="header-icon icon mx-3" /></a>
                                        <a href="#"><FaFacebookSquare className="header-icon icon mx-3" /></a>
                                        <a href="#"><FaTwitterSquare className="header-icon icon mx-3" /></a>
                                    </div>
                                </div>
                            </div>
